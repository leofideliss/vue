<template>
	<div id="app">
		...
		<component :is="componente" > <span> Conteúdo do Componente <strong>{{componente}}</strong> </span> </component>
		<!-- <Vermelho >  </Vermelho>
		<Verde > <span  slot="verde"> Conteúdo do Componente Verde</span> </Verde>
		<Azul > Conteúdo do Componente Vermelho</Azul> -->
	</div>
</template>
